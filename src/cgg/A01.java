		...
		class ColoredChecker {
			...
			Color getColor(double checkerPatternX, double checkerPatternY, int squareX, int squareY) {
				...
				if (xCheckSquare && yCheckSquare) {
					...
					// hier wird geschaut ob die Rechnungen von davor, addiert, gerade ist, wenn ja dann wird die Farbe gewechselt
					// sonst wird die andere Farbe gewählt, so kommt dann am Ende das Schachbrettmuster zustande
