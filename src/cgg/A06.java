...
public class A06 {
	public static void main(String[] args) {
		...
		Shape globe1 = new Kugel(Point.point(-0.75, -0.2, -1), 0.3, new Diffuse(new Constant(new Color(0.3, 0.8, 1))));
		Shape globe2 = new Kugel(Point.point(-1, 0, -2.5), 0.5, new Metall(new Constant(new Color(0.3, 0.4, 1)), 0));
		
		Shape globe3 = new Kugel(Point.point(0, 1.5, -5), 2, new Metall(new Constant(new Color(0.3, 0.2, 1)), 0.2));
		
		Shape globe4 = new Kugel(Point.point(1.0, 0, -2.5), 0.5, new Metall(new Constant(new Color(0.4, 0.2, 1)), 0));
		Shape globe5 = new Kugel(Point.point(0.75, -0.2, -1), 0.3, new Diffuse(new Constant(new Color(0.8, 0.2, 1))));
		
		Shape globe6 = new Kugel(Point.point(0, -0.2, 0.3), 0.2, new Diffuse(new Constant(Color.red)));
		...
		Shape globe7 = new Kugel(Point.point(-0.5, 0, -1.5), 0.5, new Diffuse(new Constant(new Color(0.3, 0.4, 1))));
		Shape globe8 = new Kugel(Point.point(0.5, 0, -1.5), 0.5, new Diffuse(new Constant(new Color(0.4, 0.2, 1))));
		
		Shape globe9 = new Kugel(Point.point(0, 0.05, -0.5), 0.1, new Glass(new Constant(Color.white)));
